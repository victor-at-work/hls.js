...
import { bin2str, findBox, parseVideoSegmentTextTrackSamples, parseVideoSegmentId3TrackSamples, readUint32 } from '../utils/mp4-tools';
 ...
 */
  ...
  append (data, timeOffset, contiguous, accurateTimeOffset) {
    ...
    if (data && data.length && videoTrack) {
      ...
      id3Track.samples = parseVideoSegmentId3TrackSamples(data);
